...
## Project Structure
    ...
    ├── newtesttoast_dev_23802  # Django project configurations
...
1. Clone this repo and `cd newtesttoast_dev_23802`
...
2. Clone this repo and `cd newtesttoast_dev_23802`
